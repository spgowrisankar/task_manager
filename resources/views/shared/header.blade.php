<header class="navbar pcoded-header navbar-expand-lg navbar-light headerpos-fixed header-blue">
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            ...
            <img src="{{ asset('assets/images/user/logo-icon.png') }}" alt="" class="logo-thumb">
        </a>
            ...
            <li>
                <div class="dropdown drp-user">
                    <a href="#!" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('assets/images/user/gowri.jpg') }}" class="img-radius wid-40" alt="User-Profile-Image">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="{{ asset('assets/images/user/gowri.jpg') }}" class="img-radius" alt="User-Profile-Image">
